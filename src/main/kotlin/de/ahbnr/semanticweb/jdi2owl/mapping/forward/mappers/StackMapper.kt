...
import de.ahbnr.semanticweb.jdi2owl.mapping.forward.mappers.component_maps.runtime_components.mapStack
...
class StackMapper : IMapper {
    private class Graph(
        ...
        override fun graphBaseFind(triplePattern: Triple): ExtendedIterator<Triple> {
            ...
            val context = MappingContext.create(tripleCollector, buildParameters)
            mapStack(context)
